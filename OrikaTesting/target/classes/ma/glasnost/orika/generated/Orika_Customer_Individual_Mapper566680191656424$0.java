...
public class Orika_Customer_Individual_Mapper566680191656424$0 extends ma.glasnost.orika.impl.GeneratedMapperBase {
...
if (((!(((au.com.home.local.orika.output.IndividualDetail)destination.getDetails()) == null)) && ((ma.glasnost.orika.Filter)usedFilters[0]).shouldMap(((ma.glasnost.orika.metadata.Type)usedTypes[0]), "gender", ((java.lang.String)source.getGender()), ((ma.glasnost.orika.metadata.Type)usedTypes[0]), "details.gender", ((java.lang.String)((au.com.home.local.orika.output.IndividualDetail)destination.getDetails()).getGender()), mappingContext)) || (((((au.com.home.local.orika.output.IndividualDetail)destination.getDetails()) == null)) && ((ma.glasnost.orika.Filter)usedFilters[0]).shouldMap(((ma.glasnost.orika.metadata.Type)usedTypes[0]), "gender", ((java.lang.String)source.getGender()), ((ma.glasnost.orika.metadata.Type)usedTypes[0]), "details.gender", null, mappingContext))) {
if ( !(((java.lang.String)source.getGender()) == null)){ 
((au.com.home.local.orika.output.IndividualDetail)destination.getDetails()).setGender(((java.lang.String)((ma.glasnost.orika.Filter)usedFilters[0]).filterDestination(((java.lang.String)((ma.glasnost.orika.Filter)usedFilters[0]).filterSource(((java.lang.String)source.getGender()), ((ma.glasnost.orika.metadata.Type)usedTypes[0]), "gender", ((ma.glasnost.orika.metadata.Type)usedTypes[0]), "gender", mappingContext)), ((ma.glasnost.orika.metadata.Type)usedTypes[0]), "gender", ((ma.glasnost.orika.metadata.Type)usedTypes[0]), "gender", mappingContext))); 
}
}
