...
public class Orika_Customer_Individual_Mapper567249124508715$0 extends ma.glasnost.orika.impl.GeneratedMapperBase {
...
if ( !(((java.lang.String)source.getGender()) == null)){ 
((au.com.home.local.orika.output.IndividualDetail)destination.getDetails()).setSex(((java.lang.String)((ma.glasnost.orika.Filter)usedFilters[0]).filterDestination(((java.lang.String)((ma.glasnost.orika.Filter)usedFilters[0]).filterSource(((java.lang.String)source.getGender()), ((ma.glasnost.orika.metadata.Type)usedTypes[0]), "gender", ((ma.glasnost.orika.metadata.Type)usedTypes[0]), "sex", mappingContext)), ((ma.glasnost.orika.metadata.Type)usedTypes[0]), "gender", ((ma.glasnost.orika.metadata.Type)usedTypes[0]), "sex", mappingContext))); 
}
}
